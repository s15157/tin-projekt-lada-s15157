function validateForm() {
   ...
   resetErrors([brandInput, modelInput, engineInput, powerInput, typeInput, priceInput, bailInput], [errorBrand, errorModel, errorEngine, errorPower, errorType, errorPrice], errorsSummary, errorBail); 
    ...
    if (!checkRequired(bailInput.value)) {
        valid = false;
        generationInput.classList.add("error-input");
        errorGeneration.innerText = "Pole jest wymagane";
    }
